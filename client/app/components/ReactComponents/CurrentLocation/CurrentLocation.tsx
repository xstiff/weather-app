...
export const CurrentLocation = () => {
  ...
  return (
    <div className="CurrentLocation-Display">
      ...
      <div className="row">
        <p>
          <strong>Status Weather</strong> {data.status_weather}
        </p>
        <p>
          <strong>Cloud Coverage</strong> {data.cloud_coverage}%
        </p>
      </div>
      <div className="row">
        <p>
          <strong>Min Temperature</strong> {data.min_temperature} °C
        </p>
        <p>
          <strong>Max Temperature</strong> {data.max_temperature} °C
        </p>
      </div>
      <div className="row">
        <p>
      ...
      <div className="row">
        ...
        <p>
          <strong>Wind Direction</strong> {data.wind_direction} &deg;
        </p>
      </div>
      <div className="row">
        <p>
          <strong>Sunrise Time</strong> {data.sunrise_time.slice(11, 16)}
        </p>
        <p>
          <strong>Sunset Time</strong> {data.sunset_time.slice(11, 16)}
        </p>
      </div>
      <div className="row">
        <p>
